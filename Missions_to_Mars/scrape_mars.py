...
mars_collection["featured_image_url"] = "https://www.jpl.nasa.gov" + picture_source[2]
...
for img in schia_img:
    ...
    schia_full_img = pic.find('a')['href']
...
for img in syrtis_img:
    ...
    syrtis_full_img = pic.find('a')['href']
...
for img in valles_img:
    ...
    valles_full_img = pic.find('a')['href']
